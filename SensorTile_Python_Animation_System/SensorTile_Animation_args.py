...
turtMcBurt = turtle.Turtle()
#turtMcBurt.penup()
#turtMcBurt.forward(150)
turtMcBurt.dot()
#turtMcBurt.goto(100,100)
turtMcBurt.hideturtle()
...
def animate(i, ys1, ys2):
    ...
    line2.set_ydata(ys2)
    turtMcBurt.goto(ys1[0]/5,ys2[0]/5)
    disp = ((ys1[0]-ys1[1])*(ys1[0]-ys1[1]) + (ys2[0]-ys2[1])*(ys2[0]-ys2[1]))
    turtMcBurt.pencolor(tkColors[int(disp%len(tkColors))])
    turtMcBurt.dot()
    return line1, line2,
